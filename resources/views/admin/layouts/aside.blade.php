    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y px-2 my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{url('admin/client')}}">
                        ...
                        <span class="menu-title">اعضاء النادي</span>
                    </a>
                </div>
            </div>
            ...
            <div
                ...
                id="#kt_aside_menu" data-kt-menu="true">
                <div class="menu-item">
                    <a class="menu-link" href="{{url('admin/partner')}}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-muted svg-icon-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                     fill="none">
                        ...
                        <span class="menu-title">لائحة النادي</span>
                    </a>
                </div>
            </div>
            ...
            <div
                ...
                id="#kt_aside_menu" data-kt-menu="true">
                <div class="menu-item">
                    <a class="menu-link" href="{{url('admin/edit-setting')}}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-muted svg-icon-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                     fill="none">
                    ...
                    <div class="me-n2">
                        ...
                        <div
                            ...
                            <div class="menu-item px-5">
                                <a href="{{url('admin/show-admin')}}/{{Auth::user()->id}}" class="menu-link px-5">حسابي</a>
                            </div>
                            <!--end::Menu item-->
