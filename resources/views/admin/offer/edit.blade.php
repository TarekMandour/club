...
@section('breadcrumb')
    <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">العروض | {{$data->title}}</h1>
@endsection
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <!--begin::Form-->
                <form id="kt_account_profile_details_form" action="{{url('admin/update-offer')}}" class="form"
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <input type="text" name="title" class="form-control mb-2"
                                                       placeholder="ادخل اسم العرض" value="{{$data->title}}"/>
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <input type="text" name="title_en" class="form-control mb-2"
                                                       placeholder="ادخل اسم العرض EN" value="{{$data->title_en}}"/>
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
